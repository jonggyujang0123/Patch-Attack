...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_channel = 3, num_classes=1000, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(num_channel, self.inplanes, kernel_size=3, stride=1, padding=1,
                               bias=False)
