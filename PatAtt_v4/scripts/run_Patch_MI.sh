...
do
    ...
    then
		command="python tools/main.py --epochs=30 --target-dataset=celeba --aux-dataset=cifar100 --train-batch-size=64 --lr=1e-3 --w-attack=50.0 --n-df=512 --patch-size=8 --patch-stride=4 --patch-padding=0 --gan-labelsmooth=0.7 --n-disc=1 --w-disc=0.3 --target-class=$((cls))"
    fi
