...
do
    ...
    then
		command="python tools/main.py --epochs=30 --target-dataset=cifar10 --aux-dataset=cifar100 --train-batch-size=64 --lr=3e-4 --n-gf=64 --n-df=256 --level-g=3 --level-q=3 --w-attack=1.0 --epoch-pretrain=1 --gan-labelsmooth=0.0 --patch-size=6 --patch-stride=2 --patch-padding=0 --target-class=1 --n-disc=2 --w-disc=0.3 --n-cont=3 --w-cont=0.15 --target-class=$((cls-1))"
    fi
    elif [ "$DATA" = "celeba" ]
    then
		command="python tools/main.py --epochs=30 --target-dataset=celeba --aux-dataset=cifar100 --train-batch-size=64 --lr=3e-4 --n-gf=64 --n-df=256 --level-g=4 --level-q=3 --w-attack=1.0 --epoch-pretrain=1 --gan-labelsmooth=0.0 --patch-size=12 --patch-stride=4 --patch-padding=0 --target-class=1 --n-disc=2 --w-disc=0.3 --n-cont=3 --w-cont=0.15 --target-class=$((cls-1))"
    fi
